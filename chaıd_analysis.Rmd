...
output:
  ...
  html_document:
    df_print: paged
---
# ÖDEV 2 – VERİ MADENCİLİĞİ TEKNİKLERİ İLE CHAID UYGULAMASI
...
CHAID paketi R'de doğrudan kullanılabilir olmayabilir, çünkü R reposunda yaygın bir paket değildir. Ancak, benzer işlevsellik sağlayan başka paketler ve alternatifler de mevcuttur.

Bir alternatif olarak, party paketiyle CHAID benzeri karar ağacı modelleri oluşturabilirsiniz. party paketi, ctree() fonksiyonu kullanarak karar ağacı oluşturmanızı sağlar ve verilerdeki bağımsız değişkenlerin etkileşimlerini incelemenize olanak tanır.
```{r}
